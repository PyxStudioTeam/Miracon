alter table public.projects
  add column if not exists walkthrough_video_enabled boolean not null default false,
  add column if not exists walkthrough_video_title text not null default 'Virtual walkthrough',
  add column if not exists walkthrough_video_desktop_url text not null default '',
  add column if not exists walkthrough_video_mobile_url text,
  add column if not exists walkthrough_video_poster_url text;
